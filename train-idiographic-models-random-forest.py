        ...
        for target in targets[6:]:
            ...
            for pp in data.id.unique().tolist():
                ...
                if X_train.shape[0] > 9:
                    ...
                    # Save model
                    with open('/home/haalbers/sleep-estimation/gen/analysis/output/idiographic/models/rf_' + target + "_" + pp +  "_" + str(feature_set_number) + '.pkl','wb') as f:
                        pickle.dump(model,f)
                    ...
                    performance_single_target.to_csv("/home/haalbers/sleep-estimation/gen/analysis/output/idiographic/accuracy/rf_" + target +  "_" + str(feature_set_number) + ".csv")
                    ...
                    predictions_multiple_subjects.to_csv("/home/haalbers/sleep-estimation/gen/analysis/output/idiographic/predictions/rf_" + target + "_" + str(feature_set_number) + ".csv")
