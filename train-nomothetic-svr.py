    ...
    for feature_set_number, feature_set in enumerate([features[:60], features[60:], features]):
        ...
        for n, pp in enumerate(userlist):
            ...
            for target in targets[6:]:
                ...
                # Save model
                with open('/home/haalbers/sleep-estimation/gen/analysis/output/nomothetic/models/nomothetic-svr-' + target + "_CV_" + str(n) + "_FEATURE_SET_" + str(feature_set_number) + '.pkl','wb') as f:
                ...
                test_predictions.to_csv("/home/haalbers/sleep-estimation/gen/analysis/output/nomothetic/predictions/svr-" + target + "_CV_" + str(n) + "_FEATURE_SET_" + str(feature_set_number) + ".csv")
                ...
                accuracies.to_csv("/home/haalbers/sleep-estimation/gen/analysis/output/nomothetic/accuracy/model-performance-svr-" + target + "_FEATURE_SET_" + str(feature_set_number) + ".csv")
